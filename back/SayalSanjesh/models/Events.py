...
# -------------------------------------------------EventsView-----------------------------------------------------------
class CustomEventViewManager(models.Manager):
    ...
    def serialize(self, queryset):
        ...
        for obj in queryset:
            serialized_obj = {
                "event_view_id": obj.event_view_id,
                "event": {
                    "event_id": obj.event.event_id},
                "admin":
                    {
...
class EventView(models.Model):
    event_view_id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    event = models.ForeignKey(Event, on_delete=models.CASCADE)
    admin = models.ForeignKey(Admins, on_delete=models.CASCADE)
    viewed_at = models.DateTimeField(auto_now_add=True)
    objects = CustomEventViewManager()
