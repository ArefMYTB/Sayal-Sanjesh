...
class WaterMeterSerializer:
    ...
    def admin_edit_water_meter_serializer(
        ...
        if token_result["status"] == "OK":
            ...
            if AdminsSerializer.admin_check_permission(admin_id, 'CRUDDevice'):
                ...
                return result
            elif AdminsSerializer.admin_check_permission(admin_id, 'CRUDDevice'):
    ...
    def admin_get_all_water_meters_serializer(token, page, count, user_id, project_id, water_meter_serial,
        ...
        if token_result["status"] == "OK":
            admin_id = token_result["data"]["user_id"]
            # TODO: Admin should see all devices
    ...
    def admin_get_location_serializer(token, type_id_list, project_id_list, tag_id_list):
        ...
        if token_result["status"] == "OK":
            ...
            elif AdminsSerializer.admin_check_permission(admin_id, 'ViewDevice'):
                try:
    ...
    def v2_admin_get_all_water_meters_serializer(token, page, count, user_id, project_id, water_meter_serial,
        ...
        if token_result["status"] == "OK":
            ...
            elif AdminsSerializer.admin_check_permission(admin_id, ['ViewProject', 'Store', 'BillManaging', 'Verification', 'Reports', 'OrderManaging', 'CRUDDevice', 'ViewDevice']):
                fields = {
                    "page": (page, int),
                    "count": (count, int),
                }
