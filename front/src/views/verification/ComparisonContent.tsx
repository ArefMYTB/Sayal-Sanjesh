  ...
  return (
    <>
      ...
      <div className="flex flex-col items-start justify-center gap-6 md:flex-row">
        {/* Table Section */}
        <div className="min-w-[400px] self-stretch overflow-auto rounded-lg border p-4">
          <Table variant="simple" size="md">
            <Thead>
              <Tr>
                <Th fontSize="l" textAlign="center">
                  ویژگی
                </Th>
                <Th fontSize="l" textAlign="center">
                  برداشت اول
            ...
            <Tbody>
              <Tr>
                ...
                <Td textAlign="center">
                  {formatJalaliDate(itemA.create_time)}
                </Td>
                <Td textAlign="center">
                  {formatJalaliDate(itemB.create_time)}
                </Td>
              </Tr>
              <Tr>
                <Td textAlign="center">ساعت</Td>
                <Td textAlign="center">
                  {formatJalaliTime(itemA.create_time)}
                </Td>
                <Td textAlign="center">
                  {formatJalaliTime(itemB.create_time)}
                </Td>
              </Tr>

              <Tr>
                <Td textAlign="center">مقدار مکانیکی (لیتر)</Td>
                <Td textAlign="center">{itemA.mechanic_value}</Td>
                <Td textAlign="center">{itemB.mechanic_value}</Td>
              </Tr>
              <Tr>
                <Td textAlign="center">مقدار تجمعی (لیتر)</Td>
                <Td textAlign="center">{itemA.cumulative_value}</Td>
                <Td textAlign="center">{itemB.cumulative_value}</Td>
              </Tr>
              <Tr>
                <Td colSpan={3}>
                  <div className="border-black my-2 border-t-2"></div>
                </Td>
              </Tr>
              <Tr>
              ...
              <Tr>
                <Td textAlign="center">تفاوت مقدار مکانیکی (لیتر)</Td>
                <Td colSpan={2} textAlign="center">
                  {diffMechanicValue}
                </Td>
              </Tr>
              <Tr>
                <Td textAlign="center">تفاوت مقدار تجمعی (لیتر)</Td>
                <Td colSpan={2} textAlign="center">
                  {diffCumulativeValue}
                </Td>
              </Tr>
